  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState4 = React2.useState, useEffect2 = React2.useEffect, useLayoutEffect2 = React2.useLayoutEffect, useDebugValue3 = React2.useDebugValue;
...
// node_modules/privategpt-sdk-web/react/use-chat.js
var import_react3 = __toESM(require_react());

// node_modules/privategpt-sdk-web/react/utils.js
...
async function getAssistantResponse({ fn, args, onNewMessage, abortController }) {
  var _a;
  ...
  while (loopRunner) {
    ...
    if (completion.choices && completion.choices[0]) {
      result += (_a = completion.choices[0].delta) == null ? void 0 : _a.content;
    }
    onNewMessage == null ? void 0 : onNewMessage(completion);
...
// node_modules/privategpt-sdk-web/react/use-chat.js
var useChat = ({ messages, includeSources = false, useContext: useContext2 = false, onFinish, client, enabled = true, systemPrompt, contextFilter }) => {
  var _a;
  const [completion, setCompletion] = (0, import_react3.useState)("");
  const abortController = (0, import_react3.useRef)(null);
  const queryKey = ["chat", messages];
  const shouldFetch = enabled && messages.length > 0 && ((_a = messages[messages.length - 1].content) == null ? void 0 : _a.trim()) !== "" && messages[messages.length - 1].role === "user";
  const fetcher = async () => {
    abortController.current = new AbortController();
    let sources = [];
    const result = await getAssistantResponse({
      fn: client.contextualCompletions.chatCompletionStream.bind(client.contextualCompletions),
      args: [
        {
          messages: systemPrompt ? [{ content: systemPrompt, role: "system" }, ...messages] : messages,
          includeSources,
      ...
      onNewMessage: (openAiCompletion) => {
        ...
        const message = ((_c = (_b = (_a2 = openAiCompletion.choices) == null ? void 0 : _a2[0]) == null ? void 0 : _b.delta) == null ? void 0 : _c.content) || "";
        const chunks = ((_f = (_e = (_d = openAiCompletion.choices) == null ? void 0 : _d[0]) == null ? void 0 : _e.sources) == null ? void 0 : _f.reduce((acc, chunk) => {
          const chunkInAcc = acc.find((c) => {
            var _a3, _b2, _c2, _d2;
            return ((_b2 = (_a3 = c.document) == null ? void 0 : _a3.docMetadata) == null ? void 0 : _b2.file_name) === ((_d2 = (_c2 = chunk.document) == null ? void 0 : _c2.docMetadata) == null ? void 0 : _d2.file_name);
          });
          if (chunk && !chunkInAcc) {
            acc.push(chunk);
          }
  ...
  const { isLoading, isValidating } = useSWR(queryKey, shouldFetch ? fetcher : null, {
...
// node_modules/privategpt-sdk-web/react/use-prompt.js
var import_react4 = __toESM(require_react());
var usePrompt = ({ prompt, includeSources = false, useContext: useContext2 = false, onFinish, client, systemPrompt, enabled = true, contextFilter }) => {
  const [completion, setCompletion] = (0, import_react4.useState)("");
  const abortController = (0, import_react4.useRef)(null);
  const queryKey = ["prompt", prompt];
  const shouldFetch = enabled && (prompt == null ? void 0 : prompt.trim()) !== "";
  const fetcher = async () => {
    abortController.current = new AbortController();
    if (!prompt)
      return "";
    ...
    const result = await getAssistantResponse({
      ...
      onNewMessage: (openAiCompletion) => {
        ...
        const message = ((_c = (_b = (_a = openAiCompletion.choices) == null ? void 0 : _a[0]) == null ? void 0 : _b.delta) == null ? void 0 : _c.content) || "";
        const chunks = ((_f = (_e = (_d = openAiCompletion.choices) == null ? void 0 : _d[0]) == null ? void 0 : _e.sources) == null ? void 0 : _f.reduce((acc, chunk) => {
          const chunkInAcc = acc.find((c) => {
            var _a2, _b2, _c2, _d2;
            return ((_b2 = (_a2 = c.document) == null ? void 0 : _a2.docMetadata) == null ? void 0 : _b2.file_name) === ((_d2 = (_c2 = chunk.document) == null ? void 0 : _c2.docMetadata) == null ? void 0 : _d2.file_name);
          });
          if (chunk && !chunkInAcc) {
            acc.push(chunk);
          }
...
var use3 = import_react5.default.use || ((promise) => {
  if (promise.status === "pending") {
    throw promise;
  } else if (promise.status === "fulfilled") {
    return promise.value;
...
var useSWRHandler2 = (_key, fetcher, config) => {
  ...
  const cached = (0, import_shim2.useSyncExternalStore)((0, import_react5.useCallback)(
    (callback) => subscribeCache(key, (current, prev) => {
      if (!isEqual(prev, current)) callback();
    }),
    // eslint-disable-next-line react-hooks/exhaustive-deps
...
var useSWRMutation = withMiddleware(useSWR2, mutation);

// node_modules/privategpt-sdk-web/react/use-files.js
var useFiles = ({ client, fetchFiles = false }) => {
  const getFiles = async () => {
    const response = await client.ingestion.listIngested();
    const files2 = response.data.reduce((acc, file) => {
      var _a;
      const name = (_a = file.docMetadata) == null ? void 0 : _a.file_name;
...
use-sync-external-store/cjs/use-sync-external-store-shim.development.js:
   ...
   *)
*/
//# sourceMappingURL=privategpt-sdk-web_react.js.map
